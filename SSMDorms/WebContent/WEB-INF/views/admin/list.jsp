	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="adminNumber" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学号'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">用户名:</td>
                <td><input type="text" name="adminName" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写用户名'" /></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td width="60" align="right">工号:</td>
                <td><input type="text" id="edit-studentNumber" name="adminNumber" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写学号'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">用户名:</td>
                <td><input type="text" id="edit-username" name="adminName" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写用户名'" /></td>
            </tr>
...
<script type="text/javascript">
	...
	*/
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
				...
				$("#edit-adminNumber").val(item.adminNumber);
	...
	$("#search-btn").click(function(){
		...
		var option = {adminName:$("#search-name").val()};
		if(dormsId != -1){
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'adminNumber',title:'工号',width:100},
