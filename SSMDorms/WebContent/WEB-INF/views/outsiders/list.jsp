    ...
    <!-- Begin of toolbar -->
     <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
			...
			<label>身份证号:</label>
			<input id="search-idcard" class="wu-text" style="width:100px">  
			<label>性别:</label>
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td><input type="text" name="outName" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写姓名'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">身份证号:</td>
                <td><input type="text" name="outIdCard" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写身份证号'" /></td>
            </tr>
            <tr>
...
<script type="text/javascript">
	...
	*/
	...
	$("#search-btn").click(function(){
		...
		var data = {outName:$("#search-name").val(),outIdCard:$("#search-idcard").val()};
		if(startTime!=''){
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'outName',title:'姓名',width:100,sortable:true},
			{ field:'outIdCard',title:'身份证号',width:100,sortable:true}, 
