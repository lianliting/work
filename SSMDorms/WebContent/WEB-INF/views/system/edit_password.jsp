	...
	<form id="edit-form" method="post">
        <table>
           <tr>
                ...
                <td><input type="text" name="adminNumber" class="wu-text easyui-validatebox" readonly="readonly" value="${admin.adminNumber }" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="password" id="reNewPassword" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请再次填写密码'" /></td>
            </tr>
        </table>
    </form>
</div>
